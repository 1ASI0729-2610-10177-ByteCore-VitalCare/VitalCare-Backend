...
public class NotificationsController {
    ...
    @GetMapping
    public ResponseEntity<List<NotificationResource>> getByUserId(@RequestParam Long users_id) {
        var notifications = queryService.handle(new GetNotificationsByUserIdQuery(users_id)).stream()
    ...
    public ResponseEntity<?> create(@RequestBody CreateNotificationResource resource) {
        var command = new CreateNotificationCommand(
                ...
                resource.patientId(), resource.users_id()
        );
