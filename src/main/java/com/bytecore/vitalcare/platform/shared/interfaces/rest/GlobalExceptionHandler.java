package com.bytecore.vitalcare.platform.shared.interfaces.rest;

import com.bytecore.vitalcare.platform.shared.application.result.ApplicationError;
import com.bytecore.vitalcare.platform.shared.interfaces.rest.transform.ErrorResponseAssembler;
 ...
 * <p>
 * Provides centralized exception handling so unhandled exceptions are translated
 * into consistent HTTP responses via the shared error-assembly pattern.
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles validation errors from Spring's @Valid request-body binding.
     *
     ...
     * (e.g. an unknown enum value passed to valueOf).
     *
    ...
    /**
     * Final fallback for any unexpected exception type.
     *
